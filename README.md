...
| 03 | [Composite index column order](sql/02-experiments/03-composite-index-column-order/README.md) | Placing the equality key first reduced logical reads from 690 to 3 (99.57%) by eliminating residual filtering. | Completed |
| 04 | [Cardinality estimates and data skew](sql/02-experiments/04-cardinality-estimation-data-skew/README.md) | Data-skew-aware estimates selected different plans; the rare-value seek reduced logical reads from 7,380 to 675 (90.85%). | Completed |
